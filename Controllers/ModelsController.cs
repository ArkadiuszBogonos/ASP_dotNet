...
namespace WypozyczalniaPojazdowElektrycznych3.Controllers
{
    public class ModelsController : Controller
    {
        ...
        public ModelsController(ElectricVehiclesRentalContext context)
        {
            _context = context;
        }
        ...
        {
            var electricVehiclesRentalContext = _context.Models.Include(m => m.Category).Include(m => m.Manufacturer);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,CategoryId,ManufacturerId")] Model model)
        {
            if (id != model.Id)
            {
                return NotFound();
